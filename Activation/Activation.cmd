...
cls
title  IDM Activation v0.5 - Soft98.iR
mode 90, 30
...
echo You can download it from  https://soft98.ir
goto done
)

:: Internet check with internetdownloadmanager.com ping and port 80 test

ping -n 1 soft98.ir >nul || (
%_psc% "$t = New-Object Net.Sockets.TcpClient;try{$t.Connect("""soft98.ir""", 80)}catch{};$t.Connected" | findstr /i true 1>nul
)

if not [%errorlevel%]==[0] (
call :_color %Red% "Unable to connect soft98.ir, aborting..."
goto done
)
...
set "reg=HKCU\SOFTWARE\DownloadManager /v FName /t REG_SZ /d "Soft98.iR [ SalaR ]"" & call :_rcont
...
set link=https://soft98.ir/idm_box_min.png
call :download
set link=https://soft98.ir/idman_logos.png
call :download
...
set link=https://soft98.ir/idm_about.png
call :download
set link=https://soft98.ir/indian.png
call :download
